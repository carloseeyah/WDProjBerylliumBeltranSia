...
### Sign Up Page: This page will incorporate forms, allowing the user to create a personalized profile with a username and password. This data will be saved and will allow the user to login in the future.

### Choose Your Character Page: Upon creating a profile or editing their current profile, users may choose one of the main characters as their profile picture, which will be saved.
...
![Choose Your Character](assets/ChooseYourCharacter.png)
...
### Update Profile Page
![Update Profile Page](assets/UpdateProfilePage.png)